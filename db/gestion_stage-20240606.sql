...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 06 juin 2024 à 07:50
...
INSERT INTO `employe` (`id`, `idEntreprise`, `nom`, `prenom`, `email`, `telephone`, `service`, `fonction`, `created_userid`, `created_date`) VALUES
(1, 141, 'Dupond', 'Fernand', 'test@test.de', '00 00 00 00 00', NULL, 'Président', 3, '2024-05-15 15:00:00'),
(4, 156, 'Maitre', 'Saujon', 'lemaire@saujon.fr', '0578435948', 'public', 'Maire de Saujon', 3, '2024-06-03 08:54:28'),
(92, 145, 'Monsieur', 'leBanquierDeFrance', 'lebanquierdefrance@gmail.com', '0606060606', NULL, 'Directeur du secteur de l&#039;informatique', 3, '2024-06-03 19:26:42'),
(96, 151, 'Graphi', 'Webmaster', '', '', NULL, '', 3, '2024-06-04 07:53:32'),
(98, 156, 'Sosie Maitre', 'Saujon', '', '', NULL, '', 3, '2024-06-04 10:45:51'),
(99, 38, 'Maitre', 'Jean-François', '', '', NULL, '', 3, '2024-06-04 10:53:13'),
(100, 210, 'Logan', 'Gaillard', 'logangaillard1@gmail.com', '07 83 07 83 68', NULL, 'Étudiant option SLAM', 3, '2024-06-04 11:11:01');
...
INSERT INTO `stage` (`id`, `idEntreprise`, `idMaitreDeStage`, `idEtudiant`, `idProfesseur`, `classe`, `description`, `dateDebut`, `dateFin`) VALUES
(1, 141, 1, 288, 41, 'SIO1', NULL, '2024-05-31', '2024-06-28'),
(2, 141, 1, 286, 3, 'SIO1', NULL, '2024-05-29', '2024-06-26'),
(3, 141, 1, 308, 40, 'SIO2', NULL, '2024-05-30', '2024-07-11'),
(5, 210, 100, 3, NULL, 'SIO1', NULL, '2024-05-06', '2024-06-17'),
(6, 156, 4, 315, NULL, 'SIO1', NULL, '2024-05-08', '2024-06-12');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `dateFirstConn` date DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `user` (`id`, `nom`, `prenom`, `email`, `date_entree`, `telephone`, `spe`, `classe`, `promo`, `login`, `password`, `password_reset`, `statut`, `inactif`, `dateFirstConn`) VALUES
(1, 'Dupond', 'André', '', NULL, NULL, NULL, NULL, '', 'test', '$2y$10$XzVV.OVw3QxgcuEW9ZXGEubrF0jYfVrJV73FDMLVd1zP2lOFeOtUW', 0, 'Etudiant', 1, NULL),
(2, 'prof', 'prof', NULL, NULL, NULL, NULL, 'Enseignant', '', 'prof', '$2y$10$nIrnqg66QlvFkT8KuCtrtu2GMmmX4jP.BiRA8LPaBn6am55Q0Ox4.', 1, 'Professeur', 0, NULL),
(3, 'Ornech', 'Jean-François', 'jean-francois-ornech@ac-poitiers.fr', NULL, '06 41 54 57 39', NULL, 'Enseignant', '', 'jfornech', '$2y$10$GVLSmMO4r25S2Uu.lpa6COtmNRdMr6.q.KgoDdVec.IIPtEi.GN.q', 0, 'Professeur', 0, '2024-05-05'),
(18, 'Patrice', 'DENIS ARONIS', 'mail@mail.local', NULL, '', NULL, 'Enseignant', '', 'patrice', '$2y$10$hR2DosUGTpgg/z4yy3X.vupNh9Rg7ri9rw3JIa8uJLzInmxLhBnLW', 1, 'Professeur', 0, NULL),
(20, 'Etudiant', 'etudiant de test', '', NULL, '', NULL, NULL, '', 'sio', '$2y$10$KeXbUulOY1uxBUdr.5zkDeTCDqLJHGYU8DF11Ji5PmUcBe79RI0Tq', 0, 'Etudiant', 1, NULL),
(21, 'login', 'login', NULL, NULL, NULL, NULL, NULL, '', 'login', '$2y$10$NNi/pR4j1Ne4N8MD.QFJOedZjQtNhcfPttfxHRXPLYyPGrGzBDnXu', 0, 'Etudiant', 0, NULL),
(40, 'CASTILLO', 'Jean-Christophe', '', NULL, '', NULL, 'Enseignant', '', 'castillojc', '$2y$10$4SOI336Uo8PxWwGtwXMrTOMkOd4DgtQGOifw7fEq8/SWax8BeUrCy', 1, 'Professeur', 0, NULL),
(41, 'BOUCHEREAU', 'Bertrand', '', NULL, '', NULL, 'Enseignant', '', 'bouchereaub', '$2y$10$HO4yuuq58SJBqqxnGzksCuvm4FWDBR6nWc3n6ZJHyNHdDEk2tBAK6', 1, 'Professeur', 0, NULL),
(43, 'test3', 'test3', 'test3@test3.test3', NULL, '', NULL, NULL, '', 'test3', '$2y$10$vBFEKCAj89EuGo3oLKCZwOabwVoqMpIFIRuaRielTFisKJ07pts1G', 0, 'Etudiant', 0, NULL),
(44, 'test4', 'test4', '', NULL, '', NULL, 'Enseignant', '', 'test4', '$2y$10$NtrExBcCGJpDOA/hahsUWOAby9r7QQLo1lEMNvyjKsvgLhO.sszjC', 0, 'Professeur', 0, NULL),
(283, 'BARBIER', 'loann', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'barbier.loann', '$2y$10$LgIb4/JPIgLjEKcEQGM31.bhNcPx7ifu40zjg3AXb7uOE1EWOit0u', 1, 'Etudiant', 0, NULL),
(284, 'DEGRAUW VERRY', 'axel', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'degrauwverry.axel', '$2y$10$v0pV6vOxh2UtLG7U5X5d0u5EJGszxWZE.x84Lgf1PPMUUMDtMCy4i', 1, 'Etudiant', 0, NULL),
(285, 'ERNOULT', 'gabin', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'ernoult.gabin', '$2y$10$fcd96wY6oCbEWKjQ9ezSL.IWLaLP7aFTUj8yJbO.0FXh.U.whOctG', 1, 'Etudiant', 0, NULL),
(286, 'GAILLARD', 'logan', 'logangaillard1@gmail.com', '2023-09-04', '07 83 07 83 68', '', 'SIO1', '', 'gaillard.logan', '$2y$10$ccKA7y5uJfUz2pXHdZJPhegQ5hwgwfB8549LVd8NNdO7yUxjOjB0y', 0, 'Etudiant', 0, NULL),
(287, 'KOSIOREK', 'alexandre', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'kosiorek.alexandre', '$2y$10$ZAmJ.kVgyJqEC/rVX.8vGeq6fXYIxjUPf/V2S9s5YZhJS5ntlcvmy', 1, 'Etudiant', 0, NULL),
(288, 'LE ROCHELEUIL  CHAILLE', 'alexis', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'lerocheleuilchaille.alexis', '$2y$10$qoWwikAq8GHhAdBGUVyqF.aqCMuGwntJZXyBwUy5dkpdF1tcEyaVq', 1, 'Etudiant', 0, NULL),
(289, 'LESCOUZERE', 'matheo', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'lescouzere.matheo', '$2y$10$HqU1mgQicDfWOabvOJ7PyuCeBQ5oQ6yISR7XOtbrhdbG5QXzqXb0C', 1, 'Etudiant', 0, NULL),
(290, 'MANUKYAN', 'astghik', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'manukyan.astghik', '$2y$10$PNd9ccVd.omSeZvPR9dabOCZdqJFXCI0JwE.MLzrxnN/Q6Nu3QemC', 1, 'Etudiant', 0, NULL),
(291, 'MINGOUOLO', 'noah', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'mingouolo.noah', '$2y$10$p5tkLzkj1RiVHyzn5WWdVOcr1E7t3HY30cWbq4uHQdc5.ayjOWK.C', 1, 'Etudiant', 0, NULL),
(292, 'MORNAC', 'erwan', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'mornac.erwan', '$2y$10$KaKZrvQJuGhNi/8tWIiRCeyjwzTn0dbYxePPx6knVq1lfSWxbWse6', 1, 'Etudiant', 0, NULL),
(293, 'RAMOS', 'clement', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'ramos.clement', '$2y$10$2nq9sOVxrNC6m5aKqw68f.6MmpcRzetq.qm4LpaQHCLSbuUZXeVjm', 1, 'Etudiant', 0, NULL),
(294, 'ROUX', 'kevin', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'roux.kevin', '$2y$10$3jlp/7o3pLewV5fL3GV2J.PkkNUqaSKUgqZsRdEy5zSwzX1HpZTjS', 1, 'Etudiant', 0, NULL),
(295, 'SAWANE', 'salle', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'sawane.salle', '$2y$10$D2dj.0mTOYqdJXiY.ORMJ.uwc/JqPjJqPyDbBebB/zLFjl8jtrkRq', 1, 'Etudiant', 0, NULL),
(296, 'SOUAKRI', 'lounes', NULL, '2023-09-04', NULL, '', 'SIO1', '', 'souakri.lounes', '$2y$10$eLcFIfCY.dG8pirygmu.f.9JT5GFt1WMyDw2xJEHyxLaNORBI2nee', 1, 'Etudiant', 0, NULL),
(297, 'BONNET', 'matthieu', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'bonnet.matthieu', '$2y$10$Gz6vxW7uRyF.21sW33oTMel/yIZk8AFuLP00n81LIPd8XhtrLUFA.', 1, 'Etudiant', 0, NULL),
(298, 'BUIL', 'victor', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'buil.victor', '$2y$10$oL1Hs1ChRjg.Z/ctUrW6/O3/mUNXNdotZfIzhfqpIRpQVJtOOr5Ye', 1, 'Etudiant', 0, NULL),
(299, 'BURAUD', 'mathis', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'buraud.mathis', '$2y$10$T88L.I8FH1.yPbqrA1bjbOMV5PKfbDOALVzCkrpQrfWowLMyEUKiq', 1, 'Etudiant', 0, NULL),
(300, 'COQUILLAU', 'elowan', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'coquillau.elowan', '$2y$10$4bes3wmOeU5ECpEN/8RBVOnKRXtD.3Bh9jaKaf9m9PFeDe/nueNVC', 1, 'Etudiant', 0, NULL),
(301, 'COTTEREAU', 'corentin', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'cottereau.corentin', '$2y$10$/WWjbjvMfHERxHoOPbIkoe8IScbC1AD.TeYi3ipquU4Ll2WlKfiam', 1, 'Etudiant', 0, NULL),
(302, 'DE ALMEIDA', 'angel', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'dealmeida.angel', '$2y$10$gZCtPO6nMFJVFebVNDZJSuGygJAvxwZu6jR8mhZUCgW8tMgZL4PTC', 1, 'Etudiant', 0, NULL),
(303, 'DOMENICI', 'lheo', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'domenici.lheo', '$2y$10$KCl/7Mv/IRbZTXzocHm3EulSKpLe3U/gXKeFajbA8u2No1QAYUQeC', 1, 'Etudiant', 0, NULL),
(304, 'GARNIER', 'aurelien', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'garnier.aurelien', '$2y$10$wDye3E8DE2BraJ4nDhrOPevJov6PRd4U0uxZnjApWGfsEAQoElizq', 1, 'Etudiant', 0, NULL),
(305, 'GUICHARD', 'camille', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'guichard.camille', '$2y$10$CqKEETRFqDr4XYjNjOmBuen/9SjmH.B6L1N8ZZgQ6NB9TF2ilZSUm', 1, 'Etudiant', 0, NULL),
(306, 'LEFEBVRE', 'aleksander', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'lefebvre.aleksander', '$2y$10$rP37oqAr.aFo3UgeoK20UuUvhUbOj9Sbb9VU7UG64v3yFJU5fLyQS', 1, 'Etudiant', 0, NULL),
(307, 'MENARD', 'lucas', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'menard.lucas', '$2y$10$xcl0h3lHO9lVf0TaBxFtL.YPr6ephkdgE4qEThbqFD0TyXyt6Vxni', 1, 'Etudiant', 0, NULL),
(308, 'MIE', 'martin', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'mie.martin', '$2y$10$cTxklMVeDggknfMGaUmUreUqGRUfQLutqQVSIzYSFFU9so2j4d1uq', 1, 'Etudiant', 0, NULL),
(309, 'PERODEAU', 'matheo', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'perodeau.matheo', '$2y$10$sYxXUD11lKzs9byjX4V39erc.mAlpVmEQvGre/z1fv50IuOnNGp9a', 1, 'Etudiant', 0, NULL),
(310, 'POUPEAU', 'mathieu', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'poupeau.mathieu', '$2y$10$yiNoHD8QYjSIQuDLmXUy6OSWl3ncsALNWgd195FHMwyx3XtdngnLq', 1, 'Etudiant', 0, NULL),
(311, 'TEXIER', 'hugo', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'texier.hugo', '$2y$10$GIOZRvGjkTRIEcc0ecHV.eS1CtGhDArNsJefxGMXjMaytjT8KBc2W', 1, 'Etudiant', 0, NULL),
(312, 'THOMAS', 'dorian', NULL, '2022-09-04', NULL, '', 'SIO2', '', 'thomas.dorian', '$2y$10$OS6Z5ON6SuqtAeLl/BFv5eSV4giJItE0hhpuODYELqJ0WQWpOl7TO', 1, 'Etudiant', 0, NULL),
(313, 'VINCENT', 'chloe', NULL, '2021-09-04', NULL, '', 'Ancien étudiant', '', 'vincent.chloe', '$2y$10$EndTptWnDV0GAhsM0M3MC.yWiXl/qBy4KPSYavejgoXTx18DKj86e', 1, 'Etudiant', 0, NULL),
(315, 'Guillebot', 'Damien', 'guillebot---damien@guillebot.com', '2023-09-04', '07 83 83 83 83', 'SLAM', 'SIO1', '2025', 'guillebot.damien', '$2y$10$Hj4/gjAjZR.B6avBbnKi8eNL/sHwra49014SJfLM5elIT1o8WX9tm', 1, 'Etudiant', 0, NULL),
(316, 'Prof', 'prof', '', NULL, '', NULL, 'Enseignant', NULL, 'prof.prof', '$2y$10$f5jfCrryZ0I.gtfZmrLUeuBWTmq817d8Xr12vnf/fNN6WJMNCsKFG', 1, 'Professeur', 0, NULL),
(318, 'Gaillard', 'Logan Prof', '', NULL, '', NULL, 'Enseignant', NULL, 'lpgaillard', '$2y$10$mhHBbXUsSQ9qYEoVgiYBM.gQBfV0ep7reNbt9fab3Zn.zdwYqsPWi', 1, 'Professeur', 0, NULL),
(319, 'gaillard', 'Jean-François', '', '2024-07-02', '', 'SLAM', 'SIO1', '2025', 'gaillard.jeanfrancois', '$2y$10$UmD0Bl.yOK78dcmp7IxdRukHDL0wx22lvn7wi25IA31mPvRetgfEW', 1, 'Etudiant', 0, NULL);
...
ALTER TABLE `stage`
  ...
  ADD CONSTRAINT `Stage_ibfk_4` FOREIGN KEY (`idProfesseur`) REFERENCES `user` (`id`);
COMMIT;
