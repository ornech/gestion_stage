...
--
-- Hôte : localhost:3306
-- Généré le : mer. 12 juin 2024 à 18:07
...
(1, NULL, 'Dupond', 'André', '', NULL, NULL, NULL, 'SIO1', '2025', 'test', '$2y$10$XzVV.OVw3QxgcuEW9ZXGEubrF0jYfVrJV73FDMLVd1zP2lOFeOtUW', 0, 'Etudiant', 1, NULL, 0),
...
,`dateCreation` datetime /* mariadb-5.3 */
);
...
-- (Voir ci-dessous la vue réelle)
--
CREATE TABLE `vue_stage` (
`idStage` int(11)
,`idEntreprise` int(11)
,`idMaitreDeStage` int(11)
,`idEtudiant` int(11)
,`idTuteur` int(11)
,`classe` varchar(10)
,`Statut` varchar(100)
...
--
-- Index pour la table `categoriejuridique`
--
ALTER TABLE `categoriejuridique`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `employe`
  ...
  ADD KEY `created_userId` (`created_userid`);
...
ALTER TABLE `logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idActivite` (`idLogType`),
  ADD KEY `idUser` (`idUser`) USING BTREE;

--
-- Index pour la table `log_type`
--
...
ALTER TABLE `stage`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idEntreprise` (`idEntreprise`),
  ADD KEY `idMaitreDeStage` (`idMaitreDeStage`),
...
--
-- AUTO_INCREMENT pour la table `log_type`
--
ALTER TABLE `log_type`
