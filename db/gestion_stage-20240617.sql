...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 17 juin 2024 à 14:06
...
-- Procédures
--
DROP PROCEDURE IF EXISTS `anonymize_employes`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `anonymize_employes` ()   BEGIN
    ...
    -- Obtenir l'ID de l'employé "Anonymous"
    ...
    main_loop: LOOP
        ...
        -- Mettre à jour les références de stage
        UPDATE stage 
...
CREATE TABLE IF NOT EXISTS `classe` (
  ...
  `nomProf` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
INSERT INTO `classe` (`id`, `idProfPrincipal`, `nomProf`, `nomClasse`, `dateDebutStage`, `dateFinStage`) VALUES
(1, 3, 'Ornech Jean-François', 'SIO1', NULL, NULL),
(2, 18, 'Patrice DENIS ARONIS', 'SIO2', NULL, NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=1000022 DEFAULT CHARSET=utf16;
...
(0, NULL, 'ANONYMOUS', 'Anonymous', NULL, NULL, NULL, NULL, NULL, NULL, 0),
...
CREATE TABLE IF NOT EXISTS `entreprise` (
  ...
  PRIMARY KEY (`id`),
  KEY `Created_UserID` (`Created_UserID`)
) ENGINE=InnoDB AUTO_INCREMENT=232 DEFAULT CHARSET=utf16;
...
(2, 'CERCLE DE LA BASE DE DEFENSE ROCHEFORT - COGNAC', '  ZONE MILITAIRE', NULL, 'ROCHEFORT', '05 46 88 80 00', '17300', NULL, '18170900700023', '56.29B', '7450', '-', 3, '2024-06-13 13:01:34', 1),
...
(23, 'CENTRE HOSPITALIER DE ROCHEFORT', '1 AVENUE DE BELIGON', NULL, 'ROCHEFORT', NULL, '17300', NULL, '26170033000135', '86.10Z', '7364', '41', 3, '2024-06-13 11:46:09', 1),
...
(230, 'LA POSTE', '9 RUE DU COLONEL PIERRE AVIA', NULL, 'PARIS', NULL, '75015', NULL, '35600000000048', '53.10Z', '5510', '51', 3, '2024-06-13 12:28:43', 1),
(231, 'SOCIETE GENERALE', '29 BOULEVARD HAUSSMANN', NULL, 'PARIS', NULL, '75009', NULL, '55212022200013', '64.19Z', '5599', '41', 3, '2024-06-13 12:32:46', 1);
...
CREATE TABLE IF NOT EXISTS `logs` (
  ...
  `idUser` int NOT NULL,
  `entite_type` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(2, 141, 1, 286, 'SIO1', 'Ceci est un test g g g g', '2024-05-29', '2024-07-10'),
(3, 141, 1, 308, 'SIO2', NULL, '2024-05-30', '2024-07-11'),
(6, 156, 4, -1, 'SIO1', NULL, '2024-05-08', '2024-06-12'),
(11, 210, 101, 304, 'SIO2', NULL, '2024-06-05', '2024-07-10');
...
) ENGINE=InnoDB AUTO_INCREMENT=323 DEFAULT CHARSET=utf16;

--
-- Déchargement des données de la table `user`
--

INSERT INTO `user` (`id`, `idTuteur`, `idClasse`, `nom`, `prenom`, `email`, `date_entree`, `telephone`, `spe`, `classe`, `promo`, `login`, `password`, `password_reset`, `statut`, `inactif`, `dateFirstConn`, `isDeleted`) VALUES
(-1, NULL, NULL, 'ANONYMOUS', 'Anonymous', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1),
(1, NULL, 1, 'Dupond', 'André', '', NULL, NULL, NULL, 'SIO1', '2025', 'test', '$2y$10$XzVV.OVw3QxgcuEW9ZXGEubrF0jYfVrJV73FDMLVd1zP2lOFeOtUW', 0, 'Etudiant', 1, NULL, 0),
(2, NULL, NULL, 'prof', 'prof', NULL, NULL, NULL, NULL, 'Enseignant', '', 'prof', '$2y$10$nIrnqg66QlvFkT8KuCtrtu2GMmmX4jP.BiRA8LPaBn6am55Q0Ox4.', 1, 'Professeur', 0, NULL, 0),
(3, NULL, NULL, 'Ornech', 'Jean-François', 'jean-francois-ornech@ac-poitiers.fr', NULL, '06 06 06 06 06', NULL, 'Enseignant', '', 'jfornech', '$2y$10$Xo2kT38JWy/MreODDn3VQeK5Q68yA.bH8Ki.bFbt5fLQFlGAItddK', 0, 'Professeur', 0, '2024-06-06 09:55:04', 0),
(18, NULL, NULL, 'Patrice', 'DENIS ARONIS', 'mail@mail.local', NULL, '', NULL, 'Enseignant', '', 'patrice', '$2y$10$hR2DosUGTpgg/z4yy3X.vupNh9Rg7ri9rw3JIa8uJLzInmxLhBnLW', 1, 'Professeur', 0, NULL, 0),
(20, NULL, 1, 'Etudiant', 'etudiant de test', '', NULL, '', NULL, 'SIO1', '2025', 'sio', '$2y$10$KeXbUulOY1uxBUdr.5zkDeTCDqLJHGYU8DF11Ji5PmUcBe79RI0Tq', 0, 'Etudiant', 1, NULL, 0),
(21, NULL, 1, 'login', 'login', NULL, NULL, NULL, NULL, 'SIO1', '2025', 'login', '$2y$10$NNi/pR4j1Ne4N8MD.QFJOedZjQtNhcfPttfxHRXPLYyPGrGzBDnXu', 0, 'Etudiant', 0, NULL, 0),
...
(283, NULL, NULL, 'BARBIER', 'loann', NULL, '2023-09-04', NULL, '', 'Ancien étudiant', '2023', 'barbier.loann', '$2y$10$LgIb4/JPIgLjEKcEQGM31.bhNcPx7ifu40zjg3AXb7uOE1EWOit0u', 1, 'Etudiant', 0, '2024-06-14 13:06:21', 0),
(284, NULL, 1, 'DEGRAUW VERRY', 'axel', NULL, '2023-09-04', NULL, '', 'SIO1', '2025', 'degrauwverry.axel', '$2y$10$v0pV6vOxh2UtLG7U5X5d0u5EJGszxWZE.x84Lgf1PPMUUMDtMCy4i', 1, 'Etudiant', 0, NULL, 0),
(285, 3, 1, 'ERNOULT', 'gabin', NULL, '2023-09-04', NULL, '', 'SIO1', '2025', 'ernoult.gabin', '$2y$10$fcd96wY6oCbEWKjQ9ezSL.IWLaLP7aFTUj8yJbO.0FXh.U.whOctG', 1, 'Etudiant', 0, NULL, 0),
(286, NULL, 1, 'GAILLARD', 'logan', 'logangaillard1@gmail.com', '2023-09-04', '07 00 00 00 00', '', 'SIO1', '2025', 'gaillard.logan', '$2y$10$ccKA7y5uJfUz2pXHdZJPhegQ5hwgwfB8549LVd8NNdO7yUxjOjB0y', 0, 'Etudiant', 0, '2024-06-06 12:32:03', 0),
(287, 3, 1, 'KOSIOREK', 'alexandre', NULL, '2023-09-04', NULL, '', 'SIO1', '2025', 'kosiorek.alexandre', '$2y$10$ZAmJ.kVgyJqEC/rVX.8vGeq6fXYIxjUPf/V2S9s5YZhJS5ntlcvmy', 1, 'Etudiant', 0, NULL, 0),
(288, 3, 2, 'LE ROCHELEUIL  CHAILLE', 'alexis', NULL, '2023-09-04', NULL, 'SLAM', 'SIO2', '2024', 'lerocheleuilchaille.alexis', '$2y$10$qoWwikAq8GHhAdBGUVyqF.aqCMuGwntJZXyBwUy5dkpdF1tcEyaVq', 1, 'Etudiant', 0, NULL, 0),
(289, NULL, 1, 'LESCOUZERE', 'matheo', NULL, '2023-09-04', NULL, '', 'SIO1', '2025', 'lescouzere.matheo', '$2y$10$HqU1mgQicDfWOabvOJ7PyuCeBQ5oQ6yISR7XOtbrhdbG5QXzqXb0C', 1, 'Etudiant', 0, NULL, 0),
(290, NULL, 1, 'MANUKYAN', 'astghik', NULL, '2023-09-04', NULL, '', 'SIO1', '2025', 'manukyan.astghik', '$2y$10$PNd9ccVd.omSeZvPR9dabOCZdqJFXCI0JwE.MLzrxnN/Q6Nu3QemC', 1, 'Etudiant', 0, NULL, 0),
(291, 41, 1, 'MINGOUOLO', 'noah', NULL, '2023-09-04', NULL, '', 'SIO1', '2025', 'mingouolo.noah', '$2y$10$p5tkLzkj1RiVHyzn5WWdVOcr1E7t3HY30cWbq4uHQdc5.ayjOWK.C', 1, 'Etudiant', 0, NULL, 0),
(292, 40, 1, 'MORNAC', 'erwan', NULL, '2023-09-04', NULL, 'SISR', 'SIO1', '2025', 'mornac.erwan', '$2y$10$KaKZrvQJuGhNi/8tWIiRCeyjwzTn0dbYxePPx6knVq1lfSWxbWse6', 1, 'Etudiant', 0, NULL, 0),
(293, NULL, 1, 'RAMOS', 'clement', NULL, '2023-09-04', NULL, '', 'SIO1', '2025', 'ramos.clement', '$2y$10$2nq9sOVxrNC6m5aKqw68f.6MmpcRzetq.qm4LpaQHCLSbuUZXeVjm', 1, 'Etudiant', 0, NULL, 0),
(294, 3, 1, 'ROUX', 'kevin', NULL, '2023-09-04', NULL, 'SISR', 'SIO1', '2025', 'roux.kevin', '$2y$10$f7UBIoTTt9.AvYukMzYDhe6R.tNs7DOWCXoyj.FueY5rQ55ft92iC', 1, 'Etudiant', 0, '2024-06-14 12:49:02', 0),
(295, 40, 1, 'SAWANE', 'salle', NULL, '2023-09-04', NULL, '', 'SIO1', '2025', 'sawane.salle', '$2y$10$D2dj.0mTOYqdJXiY.ORMJ.uwc/JqPjJqPyDbBebB/zLFjl8jtrkRq', 1, 'Etudiant', 0, NULL, 0),
(296, NULL, 1, 'SOUAKRI', 'lounes', NULL, '2023-09-04', NULL, '', 'SIO1', '2025', 'souakri.lounes', '$2y$10$8s1m7kP5AmzJxv0nrBOAOu/por/VY0aJzqmjQ.xzAY/z4XXPok1Um', 1, 'Etudiant', 0, '2024-06-14 12:54:58', 0),
(297, 18, 2, 'BONNET', 'matthieu', NULL, '2022-09-04', NULL, 'SLAM', 'SIO2', '2024', 'bonnet.matthieu', '$2y$10$Gz6vxW7uRyF.21sW33oTMel/yIZk8AFuLP00n81LIPd8XhtrLUFA.', 1, 'Etudiant', 0, NULL, 0),
(298, NULL, 1, 'BUIL', 'victor', NULL, '2022-09-04', NULL, '', 'SIO1', '2025', 'buil.victor', '$2y$10$oL1Hs1ChRjg.Z/ctUrW6/O3/mUNXNdotZfIzhfqpIRpQVJtOOr5Ye', 1, 'Etudiant', 0, NULL, 0),
(299, 40, 2, 'BURAUD', 'mathis', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'buraud.mathis', '$2y$10$T88L.I8FH1.yPbqrA1bjbOMV5PKfbDOALVzCkrpQrfWowLMyEUKiq', 1, 'Etudiant', 0, NULL, 0),
(300, NULL, 2, 'COQUILLAU', 'elowan', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'coquillau.elowan', '$2y$10$4bes3wmOeU5ECpEN/8RBVOnKRXtD.3Bh9jaKaf9m9PFeDe/nueNVC', 1, 'Etudiant', 0, NULL, 0),
(301, NULL, 2, 'COTTEREAU', 'corentin', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'cottereau.corentin', '$2y$10$/WWjbjvMfHERxHoOPbIkoe8IScbC1AD.TeYi3ipquU4Ll2WlKfiam', 1, 'Etudiant', 0, NULL, 0),
(302, NULL, 2, 'DE ALMEIDA', 'angel', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'dealmeida.angel', '$2y$10$vpi1.u9KaeWjNRBPjKM8Y.uxtZgxc7tBaQA1gRTiiwtzjZAVxx0vm', 1, 'Etudiant', 0, NULL, 0),
(303, NULL, 2, 'DOMENICI', 'lheo', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'domenici.lheo', '$2y$10$KCl/7Mv/IRbZTXzocHm3EulSKpLe3U/gXKeFajbA8u2No1QAYUQeC', 1, 'Etudiant', 0, NULL, 0),
(304, NULL, 2, 'GARNIER', 'aurelien', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'garnier.aurelien', '$2y$10$wDye3E8DE2BraJ4nDhrOPevJov6PRd4U0uxZnjApWGfsEAQoElizq', 1, 'Etudiant', 0, NULL, 0),
(305, NULL, 2, 'GUICHARD', 'camille', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'guichard.camille', '$2y$10$CqKEETRFqDr4XYjNjOmBuen/9SjmH.B6L1N8ZZgQ6NB9TF2ilZSUm', 1, 'Etudiant', 0, NULL, 0),
(306, NULL, 2, 'LEFEBVRE', 'aleksander', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'lefebvre.aleksander', '$2y$10$rP37oqAr.aFo3UgeoK20UuUvhUbOj9Sbb9VU7UG64v3yFJU5fLyQS', 1, 'Etudiant', 0, NULL, 0),
(307, NULL, 2, 'MENARD', 'lucas', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'menard.lucas', '$2y$10$xcl0h3lHO9lVf0TaBxFtL.YPr6ephkdgE4qEThbqFD0TyXyt6Vxni', 1, 'Etudiant', 0, NULL, 0),
(308, NULL, 2, 'MIE', 'martin', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'mie.martin', '$2y$10$cTxklMVeDggknfMGaUmUreUqGRUfQLutqQVSIzYSFFU9so2j4d1uq', 1, 'Etudiant', 0, NULL, 0),
(309, NULL, 2, 'PERODEAU', 'matheo', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'perodeau.matheo', '$2y$10$sYxXUD11lKzs9byjX4V39erc.mAlpVmEQvGre/z1fv50IuOnNGp9a', 1, 'Etudiant', 0, NULL, 0),
(310, NULL, 2, 'POUPEAU', 'mathieu', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'poupeau.mathieu', '$2y$10$yiNoHD8QYjSIQuDLmXUy6OSWl3ncsALNWgd195FHMwyx3XtdngnLq', 1, 'Etudiant', 0, NULL, 0),
(311, NULL, 2, 'TEXIER', 'hugo', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'texier.hugo', '$2y$10$GIOZRvGjkTRIEcc0ecHV.eS1CtGhDArNsJefxGMXjMaytjT8KBc2W', 1, 'Etudiant', 0, NULL, 0),
(312, NULL, 2, 'THOMAS', 'dorian', NULL, '2022-09-04', NULL, '', 'SIO2', '2024', 'thomas.dorian', '$2y$10$OS6Z5ON6SuqtAeLl/BFv5eSV4giJItE0hhpuODYELqJ0WQWpOl7TO', 1, 'Etudiant', 0, NULL, 0),
...
ALTER TABLE `entreprise`
  ADD CONSTRAINT `created_useridEntreprise` FOREIGN KEY (`Created_UserID`) REFERENCES `user` (`id`);
...
-- Évènements
--
DROP EVENT IF EXISTS `anonymize_employes_event`$$
CREATE DEFINER=`root`@`localhost` EVENT `anonymize_employes_event` ON SCHEDULE EVERY 1 MONTH STARTS '2024-06-12 18:06:36' ON COMPLETION NOT PRESERVE ENABLE DO CALL anonymize_employes()$$
