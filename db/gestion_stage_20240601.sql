...
--
-- Hôte : localhost:3306
-- Généré le : sam. 01 juin 2024 à 21:56
...
(159, 'Non défini', '3 IMPASSE DE L’EGLISE', NULL, 'LE MUNG', NULL, '17350', NULL, '51117988900031', '85.59A', 'PME', 'Non défini', 3, '2024-05-31 22:37:33');
...
(2, 141, 1, 286, 3, 'SIO1', NULL, '2024-05-29', '2024-07-03'),
(3, 141, 1, 308, NULL, 'SIO2', NULL, '2024-05-30', '2024-07-11');
...
--
-- Index pour la table `activite_etu`
--
...
--
-- AUTO_INCREMENT pour la table `activite_etu`
--
ALTER TABLE `activite_etu`
