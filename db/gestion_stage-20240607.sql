...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 07 juin 2024 à 12:29
...
--
ALTER TABLE `employe`
  ADD CONSTRAINT `created_userId` FOREIGN KEY (`created_userid`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `idTuteur` FOREIGN KEY (`idTuteur`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
