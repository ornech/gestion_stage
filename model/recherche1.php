...
echo '</select>';
echo '<input type="submit" value="Changer NAF">';
echo '</form>';

// Récupérer le code NAF sélectionné
if (isset($_GET['naf']) && array_key_exists($_GET['naf'], $tableau_naf)) {
    ...
    $codePostalEtablissement = "codePostalEtablissement:17300%20AND%20";
    $period = "periode(";
    $AND = "%20AND%20";
