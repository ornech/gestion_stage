...
?>
       ...
       <h2><?= $ficheEntreprise->nomEntreprise ?></h2>
       <div class="columns">
  <div class="column">
  <p><strong><?= $ficheEntreprise->nomEntreprise ?></strong> </p>
        <p><?= $ficheEntreprise->adresse ?>

        <?= $ficheEntreprise->codePostal ?> <?= $ficheEntreprise->ville ?></p>
        <p><strong>Siret: </strong><?= $ficheEntreprise->siret ?></p>
        <p><strong>Activité</strong> <?= $ficheEntreprise->naf ?></p>
        <p><strong>Effectif: </strong> <?= $ficheEntreprise->effectif ? $ficheEntreprise->effectif: "test" ?></p>
