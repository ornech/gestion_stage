...
<div class="columns is-centered is-mobile" style="height: 100vh; align-items: center;">
  <div class="column is-full-mobile is-two-thirds-tablet is-half-desktop is-one-third-widescreen is-one-quarter-fullhd box has-text-centered p-6">

    <svg xmlns="http://www.w3.org/2000/svg" viewBox="136 136 240 240" style="max-width: 600px; max-height: 600px;">
      <!-- Noyau central -->
    ...
    <form action="../controller/login.php" method="post" style="outline: 1px; outline-color: #1d213b;">
...
<div class="modal is-active">
  ...
  <div class="modal-card">
    <header class="modal-card-head">
      <h1 class="modal-card-title is-3">Conditions Générales d'Utilisation</h1>
    </header>
